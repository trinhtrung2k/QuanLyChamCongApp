...
//        });
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_worker, R.id.nav_product, R.id.nav_timekeeping,R.id.nav_timekeepingDetail,R.id.nav_salary,R.id.nav_change_password,R.id.nav_logout,R.id.nav_profile)
